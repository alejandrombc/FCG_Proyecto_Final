...
vec3 shadowRay(Ray r, int figura){
    ...
    if( figura != 7){
        t = triangle_intersection(triangles[2], r, hitpos);
        if(t >= 0.0){
            found = true;
            color *= 0.2;
        }
    ...
    if( figura != 8){
        t = triangle_intersection(triangles[3], r, hitpos);
        if(t >= 0.0){
            found = true;
            color *= 0.2;
        }
    ...
    if( figura != 9){
        t = triangle_intersection(triangles[4], r, hitpos);
        if(t >= 0.0){
            found = true;
            color *= 0.2;
        }
    ...
    if( figura != 10){
        t = triangle_intersection(triangles[5], r, hitpos);
        if(t >= 0.0){
            found = true;
            color *= 0.2;
        }
    ...
    if( figura != 11){
        t = triangle_intersection(triangles[6], r, hitpos);
        if(t >= 0.0){
            found = true;
            color *= 0.2;
        }
    ...
    if( figura != 12){
        t = triangle_intersection(triangles[7], r, hitpos);
        if(t >= 0.0){
            found = true;
            color *= 0.2;
        }
...
{    
        ...
        //Piramide
        triangles[2].v1 = vec3(-5.0, -1.9999, 15.0);
        triangles[2].v2 = vec3(5.0, -1.9999, 15.0);
        triangles[2].v3 = vec3(0.0, 9.0, 10.0);
        triangles[2].color = vec4(0.058, 0.988, 0.337, 1.0);

        triangles[3].v1 = vec3(5.0, -1.9999, 15.0);
        triangles[3].v2 = vec3(5.0, -1.9999, 5.0);
        triangles[3].v3 = vec3(0.0, 9.0, 10.0);
        triangles[3].color = vec4(0.058, 0.988, 0.337, 1.0);

        triangles[4].v1 = vec3(5.0, -1.9999, 5.0);
        triangles[4].v2 = vec3(-5.0, -1.9999, 5.0);
        triangles[4].v3 = vec3(0.0, 9.0, 10.0);
        triangles[4].color = vec4(0.058, 0.988, 0.337, 1.0);

        triangles[5].v1 = vec3(-5.0, -1.9999, 5.0);
        triangles[5].v2 = vec3(-5.0, -1.9999, 15.0);
        triangles[5].v3 = vec3(0.0, 9.0, 10.0);
        triangles[5].color = vec4(0.058, 0.988, 0.337, 1.0);

        triangles[6].v1 = vec3(-5.0, -1.9999, 15.0);
        triangles[6].v2 = vec3(5.0, -1.9999, 5.0);
        triangles[6].v3 = vec3(5.0, -1.9999, 15.0);
        triangles[6].color = vec4(0.058, 0.988, 0.337, 1.0);

        triangles[7].v1 = vec3(-5.0, -1.9999, 15.0);
        triangles[7].v2 = vec3(-5.0, -1.9999, 5.0);
        triangles[7].v3 = vec3(5.0, -1.9999, 5.0);
        triangles[7].color = vec4(0.058, 0.988, 0.337, 1.0);
        ...
        for (int i = 2; i < 8; i++) { 
            ...
            if (triangles[i].v1.y < 0.0) triangles[i].v1.y = 1.0;
            if (triangles[i].v2.y < 0.0) triangles[i].v2.y = 1.0;
            if (triangles[i].v3.y < 0.0) triangles[i].v3.y = 1.0;
